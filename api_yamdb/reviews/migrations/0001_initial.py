# Generated by Django 2.2.16 on 2022-05-04 15:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('moderator', 'Модератор'), ('admin', 'Администратор'), ('user', 'Авторизованный пользователь')], default='user', max_length=10, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(validators=[django.core.validators.MinValueValidator(100), django.core.validators.MaxValueValidator(2022)])),
